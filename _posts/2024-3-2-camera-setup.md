...
<launch>
  ...
  <arg name="color_width"         default="256"/>
  <arg name="color_height"        default="144"/>
...
```
    ...
    <group ns="/camera/color/image_raw/compressed">
      <param name="jpeg_quality" type="double" value="5" />
    </group>
  </group>
</launch>
